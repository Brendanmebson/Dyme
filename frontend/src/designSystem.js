...
export const getDesignTokens = (mode) => ({
  palette: {
    ...
    background: {
      default: mode === 'dark' ? '#121212' : '#f8f9fb',
      paper: mode === 'dark' ? '#1e1e1e' : '#ffffff',
    },
    text: {
      primary: mode === 'dark' ? '#f8fafc' : '#101828',
      secondary: mode === 'dark' ? '#94a3b8' : '#667085',
      disabled: mode === 'dark' ? '#475569' : '#98a2b3',
    },
    divider: mode === 'dark' ? '#2c2c2c' : '#e4e7ed',
  },
  typography: {
  ...
  components: {
    MuiButton: {
      styleOverrides: {
        root: {
          ...
          '&:hover': { boxShadow: mode === 'dark' ? '0 4px 16px rgba(0,0,0,0.5)' : '0 4px 16px rgba(244,63,110,0.25)', transform: 'translateY(-1px)' },
    ...
    MuiCard: {
      styleOverrides: {
        root: {
          borderRadius: '16px',
          boxShadow: mode === 'dark' ? 'none' : '0 1px 3px rgba(16,24,40,0.08), 0 4px 16px rgba(16,24,40,0.06)',
          border: mode === 'dark' ? '1px solid #2c2c2c' : '1px solid rgba(228,231,237,0.8)',
          backgroundImage: 'none',
          transition: 'all 0.25s cubic-bezier(0.4, 0, 0.2, 1)',
          '&:hover': {
            boxShadow: mode === 'dark' ? '0 8px 32px rgba(0,0,0,0.3)' : '0 8px 32px rgba(16,24,40,0.12)',
      ...
      styleOverrides: {
        root: {
          '& .MuiOutlinedInput-root': {
            borderRadius: '10px',
            '& fieldset': { borderColor: mode === 'dark' ? '#2c2c2c' : '#e4e7ed' },
    ...
    MuiDrawer: {
      styleOverrides: {
        paper: { borderRight: mode === 'dark' ? '1px solid #2c2c2c' : '1px solid #e4e7ed', backgroundImage: 'none' },
      },
    },
    MuiAppBar: {
      styleOverrides: {
        root: { 
          boxShadow: mode === 'dark' ? '0 1px 0 #2c2c2c' : '0 1px 0 rgba(228,231,237,1)', 
